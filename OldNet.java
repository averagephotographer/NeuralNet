...
public class OldNet {
    ...
    static double[][][] trainingCase(double[][][] weights, double[][][] biases, double[][][] data) {
        double[][] myOut = sigmoid(data[0], weights[0], biases[0]);
        double[][] myOut2 = sigmoid(myOut, weights[1], biases[1]);
        double[][] dLayer2 = backpropLast(myOut2, data[1]);
        double[][] gradWeight2 = gradientOfWeights(dLayer2, myOut);
        double[][] dLayer1 = backpropRest(dLayer2, weights[1], myOut);
        double[][] gradWeight1 = gradientOfWeights(dLayer1, data[0]);

        double[][][] wbOutput = { gradWeight1, dLayer1, gradWeight2, dLayer2 };
    ...
    static double[][][] miniBatch(double[][][] weights, double[][][] biases, double[][][][] train) {
        int numCases = train.length;

        /// Training Case 1
        double[][][] gradWeights = new double[numCases][0][0];
        double[][][] gradBiases = new double[numCases][0][0];
        for (int i = 0; i < numCases; i++) {
            double[][][] trainingCase = trainingCase(weights, biases, train[i]);

            int wTemp = 0;
            int bTemp = 0;

            for (int j = 0; j < trainingCase.length; j++) {
                if (j % 2 == 0) {
                    gradWeights[wTemp] = trainingCase[j];
                    wTemp++;
                } else {
                    gradBiases[bTemp] = trainingCase[j];
                    bTemp++;
                }
            }
        }
        ...
        // double[][][] trainingCaseTwo = trainingCase(weights, biases, train);
        /// Training Case 2
    ...
    static double[][][][] batches(double[][][] weights, double[][][] biases, double[][][][][] batches) {
    ...
    static void epoch(int numEpochs, double[][][] weights, double[][][] biases, double[][][][][] batches) {
        ...
        for (int i = 0; i < numEpochs; i++) {
            double[][][][] mbOut = batches(weights, biases, batches);
            weights = mbOut[0];
            biases = mbOut[1];
        }
    }
    ...
    public static void main(String[] csv_file_name) {
        ...
        // packing
        double[][][] case1 = { xTrain1, yTrain1 };
        double[][][] case2 = { xTrain2, yTrain2 };

        double[][][] case3 = { x2Train1, y2Train1 };
        double[][][] case4 = { x2Train2, y2Train2 };

        double[][][][] batch1 = { case1, case2 };
        double[][][][] batch2 = { case3, case4 };
